...
def calculate_point_by_player(data: CompetitionData) -> pd.DataFrame:
    ...
    points_player['P_Tegendoelpunt'] = points_player['Tegendoelpunt_p'] * points_player['Tegendoelpunt_e'] * (points_player['Minuten_Gespeeld'] > 0).astype('int')
    points_player['P_Eigen_Doelpunt'] = points_player['Eigen_Doelpunt'] * points_player['Goal_Eigen']
    points_player['P_Clean_Sheet'] = points_player['CleanSheet_p'] * (points_player['Minuten_Gespeeld']/90) * points_player['CleanSheet_e']
